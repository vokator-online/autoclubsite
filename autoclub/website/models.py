...
class Ticket(models.Model):
    subject = models.CharField(_("subject"), max_length=100, choices=SUBJECT_CHOICES, default='')
    content = models.TextField(_("content"), max_length=15000, default='', blank=True)
